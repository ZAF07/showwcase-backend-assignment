...
export class Convert {
  ...
  public static toRandomDobDetails(json: string): RandomDobDetails {
    return cast(JSON.parse(json), r("RandomDobDetails"));
  }
...
const typeMap: any = {
  RandomUserDetails: o(
    [
      { json: "results", js: "results", typ: a(r("RandomUser")) },
